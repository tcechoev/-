...
# Настройки
api_id = 27383511
api_hash = "16d1b743d73bf94e92e1f72babbcf41a"
group_id = -4765719052  # ID группы для уведомлений
tracked_chats = [8068560344,917287393] #Для отслеживания
...
def setup_database():
    conn = sqlite3.connect("/home/Tcechoy/bot/messages.db")
    cursor = conn.cursor()
    cursor.execute('''
